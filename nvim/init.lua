...
vim.keymap.set("i", "jk", "<Esc>", { desc = "Go to normal mode from insert mode" })
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>fp", builtin.find_files, { desc = "[F]search [P]files" })
			vim.keymap.set("n", "<leader>fw", builtin.grep_string, { desc = "[F]search current [W]ord" })
			vim.keymap.set("n", "<leader>ff", builtin.live_grep, { desc = "[F]search by [F]grep" })
			...
			end, { desc = "[F]search [N]eovim files" })
		end,
	},
